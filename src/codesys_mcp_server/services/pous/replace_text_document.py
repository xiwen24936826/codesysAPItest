...
def replace_text_document(
    ...
    try:
        ...
        resolved_container_path, _ = execute_text_write_flow(
            ...
            validation_error_cls=ReplaceTextDocumentValidationError,
            build_expected_text=lambda _current_text: validated_request.new_text,
            perform_write=lambda container_path: text_document_replacer.replace_text_document(
